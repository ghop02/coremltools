...
if _deps.HAS_TF_2 and TEST_TF_2:
    import tensorflow as tf
    from tensorflow.keras.models import Sequential, Model
    from tensorflow.python import keras as _keras
elif _deps.HAS_KERAS2_TF:
    import tensorflow as tf
    from keras.models import Sequential, Model
    from coremltools.converters import keras


@unittest.skipIf(not _deps.HAS_KERAS2_TF, "Missing keras. Skipping tests.")
@pytest.mark.keras2
class KerasSingleLayerTest(unittest.TestCase):
    ...
    def test_dense(self):
        ...
        model = Sequential()
        model.add(_keras.layers.Dense(32, input_dim=16))
    ...
    def test_activations(self):
        ...
        for i, k_act in enumerate(keras_activation_options):
            ...
            model = Sequential()
            model.add(_keras.layers.Dense(32, input_dim=16))
            model.add(_keras.layers.Activation(k_act))
    ...
    def test_dropout(self):
        ...
        model.add(_keras.layers.Dropout(0.5))
        model.add(_keras.layers.Dense(32, input_shape=(16,)))
    ...
    def test_upsample(self):
        ...
        model.add(
            _keras.layers.Conv2D(
                input_shape=(64, 64, 3), filters=32, kernel_size=(5, 5)
            )
        )
